    ...
    <section id="kontakty" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          >
            <div>
              <h3 className="text-2xl font-tektur font-semibold text-primary mb-6">
            ...
            <div className="bg-light-bg p-6 rounded-2xl">
              <h4 className="text-xl font-tektur font-semibold text-primary mb-4">
                Написать нам
              </h4>
              <Form {...form}>
          ...
          >
            ...
            <div className="relative">
              {/* TODO: Replace with your office photo */}
              <img
