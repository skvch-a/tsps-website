              ...
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                ...
                >
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Основанная в 2001 году, компания «Тюменский стройпроектсервис» реализовала свыше 150 (тут могло быть нужное число) проектов зданий и сооружений. Наш опыт, профессионализм и индивидуальный подход позволяют нам создавать эффективные и современные решения, соответствующие самым высоким требованиям клиентов и стандартам отрасли.
                  </p>
                  <p className="text-lg text-gray-600 leading-relaxed">
